	...
	$.extend($.fn, {
		...
		miniColors: function(o, data) {
			...
			var create = function(input, o, data) {
				...
				// Create trigger
				var trigger = $('<a title="change color" class="miniColors-trigger" style="background-color: #' + color + '" href="#"></a>');
			...
			var hide = function(input) {
				...
				if( !input )
                                    ...
                                    {
                                         //WOUTER Added: we are hiding oen specific input! 
                                         //alert('here');
                                     // Fire hide callback ADDED BY WOUTER!
                                        if( input.data('hide') ) {
                                            console.log(input);
                                            var hex = input.data('lastChange');
                                            input.data('hide').call(input, '#' + hex, hex2rgb(hex));
                                        }
                                    }
